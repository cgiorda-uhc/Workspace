...
namespace PCP_CH4_PR_PM_Profiles
{
    class PCP_CH4_PR_PM_Profiles
    {
                    ...
                    if (blHasUtilization)
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            if (blHasWord)
                            {
                                ...
                                MSWord.tryCount = 0;
                                MSWord.pasteExcelTableToWord("utilization_table", strSheetname, "A1:C15", MSExcel.xlsApp, MSExcel.xlsWB, MSExcel.xlsSheet, blAddBookmark: false);
