...
namespace PCP_CH5_PR_Profiles
{
    class PCP_CH5_PR_Profiles
    {
            ...
            try
            {
                ...
                foreach (DataRow dr in dtMain.Rows)//MAIN LOOP START
                {
                    ...
                    if (blHasUtilizationSummary) //"|blHasProcedural"
                    {
                        ...
                        strSQL = "Select act_display, expected_display, var_display, signif, favorable FROM ph15.Profile where measure_id in(1,2,3,5,37,50) and mpin=" + strMPIN + " order by sort_id";
                    ...
                    if (blHasPharmSummary)
                    {
                        ...
                        strSQL = "Select Measure_desc, Unit_measure, act_display, expected_display,var_display,signif,signif_g as favorable FROM ph15.profile_px where measure_id in(38,51,55) and mpin=" + strMPIN + "  order by sort_id";
                    ...
                    if (blHasUtilizationDetails)
                    {
                        ...
                        
                        //strSQL = "select Category, Patient_Count,Visit_Count, Pct_Cost from Ph15.PBP_act where Measure_ID=50 and attr_mpin=" + strMPIN + " order by Catg_order";
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from ph15.PBP_act where Measure_ID=37 and attr_mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getOleDbDataTableGlobal(IR_SAS_Connect.strSASConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from Ph15.PBP_act where Measure_ID=5 and attr_mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getOleDbDataTableGlobal(IR_SAS_Connect.strSASConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from ph15.PBP_act where Measure_ID=3 and attr_mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getOleDbDataTableGlobal(IR_SAS_Connect.strSASConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        strSQL = "select category,Patient_Count,Visit_Count,Pct_Cost from Ph15.PBP_act where Measure_ID=2 and attr_mpin=" + strMPIN + " order by Catg_order;";
                        dt = DBConnection64.getOleDbDataTableGlobal(IR_SAS_Connect.strSASConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        strSQL = "select Category,Patient_Count,Visit_Count,Pct_Cost from Ph15.PBP_act where Measure_ID=1 and attr_mpin=" + strMPIN + "  order by Catg_order;";
                        dt = DBConnection64.getOleDbDataTableGlobal(IR_SAS_Connect.strSASConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                    ...
                    if (blHasPharmDetails)
                    {
                        ...
                        strSQL = "Select Measure_desc, Unit_measure,act_display, expected_display, var_display from ph15.Profile_Px as a where measure_id in (56,57,58,59,60,61) and a.MPIN=" + strMPIN + " order by Hierarchy_Id";
                        dt = DBConnection64.getOleDbDataTableGlobal(IR_SAS_Connect.strSASConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        strSQL = "Select Measure_desc, Unit_measure,act_display, expected_display, var_display from ph15.Profile_Px as a where measure_id in (52,53,54) and a.MPIN=" + strMPIN + " order by Hierarchy_Id";
                        dt = DBConnection64.getOleDbDataTableGlobal(IR_SAS_Connect.strSASConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        strSQL = "Select Measure_desc, Unit_measure,act_display, expected_display, var_display from ph15.Profile_Px as a where measure_id in (40,41,42) and a.MPIN=" + strMPIN + " order by Hierarchy_Id";
                        dt = DBConnection64.getOleDbDataTableGlobal(IR_SAS_Connect.strSASConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
