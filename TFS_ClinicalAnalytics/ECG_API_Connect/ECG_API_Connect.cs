...
namespace ECG_API_Connect
{
    class ECG_API_Connect
    {
        //https://uhgazure.sharepoint.com/:p:/r/sites/ecg/public/_layouts/15/Doc.aspx?sourcedoc=%7BB7EDA1DF-E7A1-4BC7-B35F-F816BC4B2774%7D&file=API_Demo.pptx&action=edit&mobileredirect=true&cid=f51d8ab2-eee9-48e0-81a5-3422144652ed
        //https://ecgqcpift.healthtechnologygroup.com:9443/qcgatewayservice/swagger-ui/#/
        //https://ecgqc.healthtechnologygroup.com/ecgqc/contacts.do
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                IR_SAS_Connect.create_SAS_instance();//IR_SAS_Connect.create_SAS_instance(IR_SAS_Connect.getLib());
            ...
            if (blFoundError)
            {
                strFileName = "ERROR_Log_" + $@"{DateTime.Now.Ticks}.txt";
                //OutlookHelper.sendEmail("chris_giordano@uhc.com", "ER Discharge Errors!!!", sbFinalLog.ToString(), "chris_giordano@uhc.com");
            }
            else
            {
                strFileName = "Log_" + $@"{DateTime.Now.Ticks}.txt";
                //OutlookHelper.sendEmail("chris_giordano@uhc.com", "ER Discharge Errors!!!", sbFinalLog.ToString(), "chris_giordano@uhc.com");
            }
