...
namespace PR_Spec3_AdHoc_Details
{
    class PR_Spec3_AdHoc_Details
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                foreach (string s in strMpinArr)
                {
                    ...
                    //strSQL = "select MBR_FST_NM,MBR_LST_NM,INDV_BTH_DT,RISK_CATGY, PRDCT_LVL_1_NM,DOS,PROC_CD,PROC_DESC from dbo.VW_PBP_LVL45_dtl33 where attr_mpin=" + strMPIN ;
                    strSQL = "select MBR_FST_NM,MBR_LST_NM,INDV_BTH_DT,RISK_CATGY, PRDCT_LVL_1_NM,DOS,PROC_CD,PROC_DESC from dbo.VW_PBP_LVL45_dtl33 where attr_mpin=" + strMPIN + " order by MBR_LST_NM,MBR_FST_NM,DOS";
