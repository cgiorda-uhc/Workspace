    ...
    class MedicalNecessity_ACIS_Parser
    {
        static void Main(string[] args)
        {
           ...
           // return;
            ...
            HelperFunctions.HelperFunctions.Email("inna_rudi@uhc.com", "chris_giordano@uhc.com", "VC Automation Manager: ACIS MedNec Tables", "ACIS MedNec tables were updated with data for the month of March 2024", "chris_giordano@uhc.com", null, System.Net.Mail.MailPriority.Normal);
