...
namespace MedicalNecessity_ACIS_Parser
{
    class MedicalNecessity_ACIS_Parser
    {
        static void Main(string[] args)
        {
            ...
            HelperFunctions.HelperFunctions.Email("inna_rudi@uhc.com;sheila_donelan@uhc.com", "chris_giordano@uhc.com", "VC Automation Manager: ACIS MedNec Tables", "ACIS MedNec tables were updated with data for the month of April 2023", "chris_giordano@uhc.com;jon_maguire@uhc.com", null, System.Net.Mail.MailPriority.Normal);
