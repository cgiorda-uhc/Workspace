...
namespace AddCoverLetterToExistingPDF_PCP1._2
{
    class AddCoverLetterToExistingPDF_PCP12
    {
        ...
        private static void prepFile(string strFile)
        {
            ...
            PDFHelper.mergePDF(strTempPath_GLOBAL + "temp.pdf", strFile, strNewFullFilePath);
