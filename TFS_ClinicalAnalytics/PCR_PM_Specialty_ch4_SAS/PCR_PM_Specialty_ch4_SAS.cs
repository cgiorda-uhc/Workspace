...
namespace PCR_PM_Specialty_ch4_SAS
{
    class PCR_PM_Specialty_ch4_SAS
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                string strTinList = "SELECT distinct ad.MPIN as PracticeId FROM ph34.outliers as a inner join ph34.UHN_MAY6_DEMOG as b on a.MPIN=b.MPIN inner join Ph34.UHN_MAY6_PTI_DEMOG as ad on ad.mpin=b.PTIGroupID_upd inner join Ph34.OUTL_MODELS as m on m.mpin=a.mpin WHERE a.Exclude in(0,5) AND b.PTIGroupID>0  ";
                ...
                else
                {
                    ...
                    //strSQL = "SELECT ad.TaxID, ad.MPIN as PracticeId, ad.Practice_Name, ad.Street, ad.City, ad.State, ad.ZipCd, sum(a.attr_clients) as attr_clients, sum(a.opi_clients) as op_clients, SUM(Tot_util_meas) as Tot_util_meas, SUM(Tot_PX_meas) AS Tot_PX_meas, h.Folder_Name, '' as RCMO, '' as RCMO_title, '' as RCMO_title1, '' as NDB_Specialty FROM ph34.outliers as a inner join ph34.UHN_MAY6_DEMOG as b on a.MPIN=b.MPIN inner join Ph34.UHN_MAY6_PTI_DEMOG as ad on ad.mpin=b.PTIGroupID_upd inner join Ph34.spec_handling as h on h.mpin=a.mpin inner join Ph34.OUTL_MODELS as m on m.mpin=a.mpin WHERE a.Exclude in(0,5) AND b.PTIGroupID>0 AND ad.MPIN in (" + strTinList + ") GROUP BY ad.TaxID, ad.MPIN, ad.Practice_Name, ad.Street, ad.City, ad.State, ad.ZipCd, h.Folder_Name";


                    strSQL = "SELECT ad.TaxID, ad.MPIN as PracticeId, ad.Practice_Name, ad.Street, ad.City, ad.State, ad.ZipCd, sum(a.attr_clients) as attr_clients, sum(a.opi_clients) as op_clients, SUM(Tot_util_meas) as Tot_util_meas, SUM(Tot_PX_meas) AS Tot_PX_meas, h.Folder_Name, '' as RCMO, '' as RCMO_title, '' as RCMO_title1, '' as NDB_Specialty FROM ph34.outliers as a inner join ph34.UHN_MAY6_DEMOG as b on a.MPIN=b.MPIN inner join Ph34.UHN_MAY6_PTI_DEMOG as ad on ad.mpin=b.PTIGroupID_upd inner join Ph34.spec_handling as h on h.mpin=a.mpin inner join Ph34.OUTL_MODELS as m on m.mpin=a.mpin WHERE a.Exclude in(0,5) AND b.PTIGroupID>0 and ad.MPIN = "+ strTinList +" GROUP BY ad.TaxID, ad.MPIN, ad.Practice_Name, ad.Street, ad.City, ad.State, ad.ZipCd, h.Folder_Name";


                    strSQL = "SELECT ad.TaxID, ad.MPIN as PracticeId, ad.Practice_Name, ad.Street, ad.City, ad.State, ad.ZipCd, sum(a.attr_clients) as attr_clients, sum(a.opi_clients) as op_clients, utl_meas, px_meas, Folder_Name FROM ph34.outliers as a inner join ph34.UHN_MAY6_DEMOG as b on a.MPIN=b.MPIN inner join Ph34.UHN_MAY6_PTI_DEMOG as ad on ad.mpin=b.PTIGroupID_upd inner join Ph34.spec_handling as h on h.mpin=a.mpin inner join Ph34.OUTL_MODELS as m on m.mpin=a.mpin left join (select PTIGroupID,SUM(outl_idx)+SUM(outl_idx_g) as utl_meas from Ph34.PBP_PROFILE as p inner join Ph34.outliers as o on o.mpin=p.mpin inner join ph34.UHN_MAY6_DEMOG as d on o.MPIN=d.MPIN where attr_clients>=20 group by d.PTIGroupID having utl_meas>0) as ut on ut.PTIGroupID=ad.MPIN left join (select PTIGroupID,SUM(outl_idx)+SUM(outl_idx_g) as px_meas from Ph34.PBP_PROFILE_PX as p inner join Ph34.outliers as o on o.mpin=p.mpin inner join ph34.UHN_MAY6_DEMOG as d on o.MPIN=d.MPIN where o.exclude in(0,5) and Measure_ID not in(40,41,42,44) and Outl_idx is not null group by d.PTIGroupID having px_meas>0) as px on px.PTIGroupID=ad.MPIN WHERE a.Exclude in(0,5) AND b.PTIGroupID>0 AND ad.MPIN = " + strTinList + " GROUP BY ad.TaxID, ad.MPIN, ad.Practice_Name, ad.Street, ad.City, ad.State, ad.ZipCd ,Folder_Name;";
                ...
                IR_SAS_Connect.create_SAS_instance("Ph34", "/optum/uhs/01datafs/phi/projects/analytics/pbp/Ph34");
