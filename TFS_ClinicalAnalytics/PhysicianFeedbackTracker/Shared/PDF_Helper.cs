...
namespace PhysicianFeedbackTracker
{
    class PDF_Helper
    {
        ...
        public static void initializePDF(string strPDFPath)
        {
            ...
            documentGlobal.SetMargins(15, 15, 15, 15);
        }
        ...
        public static void addImage(string strImagePath)
        {
            ...
            //img.SetMarginTop(15f);
            //img.SetMarginLeft(15f);
            //img.SetMarginRight(15f);
        ...
        public static void addTable(DataTable dt, float[] pointColumnWidths)
        {
            ...
            //tablePDF.SetMarginLeft(15f);
            //tablePDF.SetMarginRight(15f);
            //tablePDF.SetMarginTop(0);
            //tablePDF.SetMarginBottom(0);

            //tablePDF.SetExtendBottomRowOnSplit(true);


            //tablePDF.SetKeepTogether(true);
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                foreach (DataColumn column in dt.Columns)
                {
                    ...
                    cellPDF = new Cell(1, 1).Add(new Paragraph(varValue.ToString()));
                    cellPDF.SetNextRenderer(new CustomCellRenderer(cellPDF));
                    ...
                    if (int.TryParse(varValue.ToString().Replace("%", "").Replace(".", "").Replace("$", "").Trim(), out _))
                        cellPDF.SetTextAlignment(TextAlignment.CENTER);
                    else
