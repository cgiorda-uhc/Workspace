...
using System.Data.SqlClient;
    ...
    public class DataRetriever : IDataPageRetriever
    {
        ...
        public DataRetriever(string connectionString, string strSQLSelect, string sortColumn, string Sortorder)
        {
            SqlConnection connection = new SqlConnection(connectionString);
            connection.Open();
            command = connection.CreateCommand();
            this.strSQL = strSQLSelect;
        ...
        public int RowCount
        {
            get
            {
                ...
                command.CommandText = "SELECT COUNT(*) as cnt FROM (" + strSQL + ") as tmp";
        ...
        public DataColumnCollection Columns
        {
            get
            {
                ...
                command.CommandText = "SELECT tmp.* FROM (" + strSQL + ") as tmp";
        ...
        public DataTable SupplyPageOfData(int lowerPageBoundary, int rowsPerPage)
        {
            ...
            command.CommandText = "Select Top " + rowsPerPage + " " +
                CommaSeparatedListOfColumnNames + " From (" + strSQL +
                ") as tmp WHERE " + columnToSortBy + " NOT IN (SELECT TOP " +
                lowerPageBoundary + " " + columnToSortBy + " From (" +
                strSQL + ") as tmp Order By " + sortColumn + " " + Sortorder +
