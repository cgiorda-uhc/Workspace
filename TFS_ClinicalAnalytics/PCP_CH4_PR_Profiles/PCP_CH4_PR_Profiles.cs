...
namespace PCP_CH4_PR_Profiles
{
    class PCP_CH4_PR_Profiles
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                string strMPINList = "select distinct  a.MPIN from dbo.PBP_Outl_Ph14 as a inner join dbo.PBP_outl_demogr_Ph14 as b on a.MPIN=b.MPIN inner join dbo.PBP_outl_PTI_addr_Ph14 as p on p.mpin=PTIGroupID_upd inner join dbo.PBP_dim_RCMO as r on r.Region=b.RGN_NM where a.Exclude in(0,5) and r.phase_id=2";
                ...
                foreach (DataRow dr in dtMain.Rows)//MAIN LOOP START
                {
                    ...
                    if (blHasUtilizationSummary) //"|blHasProcedural"
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            {
                                MSWord.tryCount = 0;
                                MSWord.pasteExcelTableToWord(strBookmarkName, strSheetname, "A1:G15", MSExcel.xlsApp, MSExcel.xlsWB, MSExcel.xlsSheet, blAddBookmark: false);
                    ...
                    if (blHasUtilizationDetails)
                    {
                        ...
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph14 where Measure_ID=36 and attr_mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph14 where Measure_ID=17 and attr_mpin=" + strMPIN + "order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from [dbo].[PBP_act_ph14] where Measure_ID=8 and attr_mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                            strSheetname = "Spec_Non_Premium_det";
                            alSectionUtilization.Add(strSheetname);
                        ...
                        //NEW!!!! 3/12/2019 CHECK SHEET BELOW TO DETERMINE IF THIS SHOULD RUN TOO
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph14 where Measure_ID=10 and attr_mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            strSQL = "select Measure_desc,Unit_Measure,act_display,expected_display,var_display from dbo.PBP_Profile_Ph14 where measure_id in(14,15) and MPIN=" + strMPIN + " order by sort_Id";
                            dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                            if (dt.Rows.Count > 0)
                            {
                        ...
                        strSQL = "select Category, Patient_Count, Pct_Cost from dbo.PBP_act_ph14 where Measure_ID=9 and attr_mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph14 where Measure_ID=37 and attr_mpin=" + strMPIN + "  order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph14 where Measure_ID=16 and attr_mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph14 where Measure_ID=4 and attr_mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
