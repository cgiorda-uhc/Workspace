...
namespace PCR_Specialty_ch3
{
    class PCR_Specialty_ch3
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                string strSampleCount = "10";
                string strMPINList = "SELECT Distinct a.MPIN FROM dbo.PBP_Outl_Ph33 as a inner join dbo.PBP_outl_demogr_Ph33 as b on a.MPIN=b.MPIN inner join dbo.PBP_outl_PTI_addr_Ph33 as p on p.mpin=PTIGroupID_upd inner join dbo.PBP_Outl_ph33_models as m on m.mpin=a.mpin inner join dbo.PBP_dim_RCMO as r on r.Region=b.RGN_NM WHERE a.Exclude in(0,5) AND r.phase_id=2";
               ...
               // strMPINList = "SELECT * FROM ( SELECT TOP " + strSampleCount + " a.MPIN FROM dbo.PBP_Outl_Ph33 as a inner join dbo.PBP_outl_demogr_Ph33 as b on a.MPIN=b.MPIN inner join dbo.PBP_outl_PTI_addr_Ph33 as p on p.mpin=PTIGroupID_upd inner join dbo.PBP_Outl_ph33_models as m on m.mpin=a.mpin inner join dbo.PBP_dim_RCMO as r on r.Region=b.RGN_NM WHERE a.Exclude in(0,5) AND r.phase_id=2 AND model_id = 1 ORDER BY NEWID() ) a UNION SELECT * FROM ( SELECT TOP " + strSampleCount + " a.MPIN FROM dbo.PBP_Outl_Ph33 as a inner join dbo.PBP_outl_demogr_Ph33 as b on a.MPIN=b.MPIN inner join dbo.PBP_outl_PTI_addr_Ph33 as p on p.mpin=PTIGroupID_upd inner join dbo.PBP_Outl_ph33_models as m on m.mpin=a.mpin inner join dbo.PBP_dim_RCMO as r on r.Region=b.RGN_NM WHERE a.Exclude in(0,5) AND r.phase_id=2 AND model_id = 2 ORDER BY NEWID() ) b UNION SELECT * FROM ( SELECT TOP " + strSampleCount + " a.MPIN FROM dbo.PBP_Outl_Ph33 as a inner join dbo.PBP_outl_demogr_Ph33 as b on a.MPIN=b.MPIN inner join dbo.PBP_outl_PTI_addr_Ph33 as p on p.mpin=PTIGroupID_upd inner join dbo.PBP_Outl_ph33_models as m on m.mpin=a.mpin inner join dbo.PBP_dim_RCMO as r on r.Region=b.RGN_NM WHERE a.Exclude in(0,5) AND r.phase_id=2 AND model_id = 3 ORDER BY NEWID() ) c UNION SELECT * FROM ( SELECT TOP " + strSampleCount + " a.MPIN FROM dbo.PBP_Outl_Ph33 as a inner join dbo.PBP_outl_demogr_Ph33 as b on a.MPIN=b.MPIN inner join dbo.PBP_outl_PTI_addr_Ph33 as p on p.mpin=PTIGroupID_upd inner join dbo.PBP_Outl_ph33_models as m on m.mpin=a.mpin inner join dbo.PBP_dim_RCMO as r on r.Region=b.RGN_NM WHERE a.Exclude in(0,5) AND r.phase_id=2 AND model_id = 4 ORDER BY NEWID() ) d UNION SELECT * FROM ( SELECT TOP " + strSampleCount + " a.MPIN FROM dbo.PBP_Outl_Ph33 as a inner join dbo.PBP_outl_demogr_Ph33 as b on a.MPIN=b.MPIN inner join dbo.PBP_outl_PTI_addr_Ph33 as p on p.mpin=PTIGroupID_upd inner join dbo.PBP_Outl_ph33_models as m on m.mpin=a.mpin inner join dbo.PBP_dim_RCMO as r on r.Region=b.RGN_NM WHERE a.Exclude in(0,5) AND r.phase_id=2 AND model_id = 5 ORDER BY NEWID() ) e";


                //strMPINList = "115787";


                //strMPINList = "1447805,1456683,1709101,1740583,1914416,1927599,1963155,2060972,2095266,2138572,2162051,2256494,2260626,2301537,2477880,2480343,2528171,2737323,2761380,2798380, 2517040,2627670,2792251,2796826,2813972,2823356,2997017,3037968,3098266,3143327,3206481,3236263,3386638,3421403,3477015,3635519,3646953,4824151";
                ...
                foreach (DataRow dr in dtMain.Rows)//MAIN LOOP START
                {
                    ...
                    string FirstName = (dr["FirstName"] != DBNull.Value ? "Dr. " + dr["FirstName"].ToString().Trim() : "");
                    string UCaseLastName = (dr["P_LastName"] != DBNull.Value ? dr["P_LastName"].ToString().Trim() : "NAME MISSING");
                    string UCaseFirstName = (dr["P_FirstName"] != DBNull.Value ? "Dr. " +  dr["P_FirstName"].ToString().Trim() : "");
                    ...
                    if (blHasWord)
                    {
                        ...
                        MSWord.wordReplace("{$start date}", strStartDate);
                        MSWord.wordReplace("{$end date}", strEndDate);
                    ...
                    if (blHasUtilizationSummary)
                    {
                        ...
                        strSQL = "select act_display, expected_display, var_display,signif,Favorable from dbo.PBP_Profile_Ph33 as a where MPIN=" + strMPIN + " order by sort_id";
                    ...
                    if (blHasProceduralSummary)
                    {
                        ...
                        switch (strSpecialty.ToUpper())
                        {
                            ...
                            case "OBGYN":
                                ...
                                strSQL = "select act_display, expected_display,var_display,signif,signif_g from dbo.PBP_Profile_px_Ph33 as a where spec_id=4 and measure_id not between 40 and 42 and MPIN=" + strMPIN + " order by sort_id";
                            ...
                            case "CARDIOLOGY":
                                ...
                                strSQL = "select act_display, expected_display,var_display,signif,signif_g from dbo.PBP_Profile_px_Ph33 as a where spec_id=5 and measure_id not between 40 and 42 and MPIN=" + strMPIN + " order by sort_id";
                                //blProcedureOnlyBreak = true;
                                break;
                            case "NEPHROLOGY":
                            case "RHEUMATOLOGY":
                                ...
                                strSQL = "select act_display, expected_display,var_display,signif,signif_g from dbo.PBP_Profile_px_Ph33 as a where spec_id in(12,9) and measure_id not between 40 and 42 and MPIN=" + strMPIN + " order by sort_id";
                            ...
                            case "NEUROLOGY":
                                ...
                                //strSQL = "select act_display, expected_display, var_display, case when signif is null then ' ' else signif end as 'Statistically Significant' from dbo.PBP_Profile_px_Ph32 as a where measure_id not in(40,41,42) and spec_id in(9,10,12) and MPIN=" + strMPIN + " order by sort_id";
                                strSQL = "select act_display, expected_display,var_display,signif,signif_g from dbo.PBP_Profile_px_Ph33 as a where spec_id=10 and measure_id not between 40 and 42 and MPIN=" + strMPIN + " order by sort_id";
                                //blProcedureOnlyBreak = false;
                                break;
                            ...
                            case "OTOLARYNGOLOGY":
                                ...
                                strSQL = "select act_display, expected_display,var_display,signif,signif_g from dbo.PBP_Profile_px_Ph33 as a where spec_id=14 and measure_id not in(40,41,42,44) and MPIN=" + strMPIN + " order by sort_id";
                                //blProcedureOnlyBreak = true;
                                break;
                            case "GENERAL SURGERY":
                                ...
                                strSQL = "select act_display, expected_display,var_display,signif,signif_g from dbo.PBP_Profile_px_Ph33 as a where spec_id=18 and measure_id not between 40 and 42 and MPIN=" + strMPIN + " order by sort_id";
                                //blProcedureOnlyBreak = true;
                                break;
                            ...
                            case "UROLOGY":
                                ...
                                strSQL = "select act_display, expected_display,var_display,signif,signif_g from dbo.PBP_Profile_px_Ph33 as a where spec_id in(13,15) and measure_id not between 40 and 42 and MPIN=" + strMPIN + " order by sort_id";
                                //blProcedureOnlyBreak = false;
                                break;
                            case "NEUROSURGERY, ORTHOPEDICS AND SPINE":
                                ...
                                strSQL = "select act_display, expected_display,var_display,signif,signif_g from dbo.PBP_Profile_px_Ph33 as a where spec_id=16 and measure_id not between 40 and 42 and MPIN=" + strMPIN + " order by sort_id";
                                //blProcedureOnlyBreak = true;
                                break;
                            ...
                            case "PULMONARY":
                                ...
                                //strSQL = "select act_display, expected_display, var_display, case when signif is null then ' ' else signif end as 'Statistically Significant' from dbo.PBP_Profile_px_Ph32 as a where measure_id not in(40,41,42) and spec_id=16 and MPIN=" + strMPIN + " order by sort_id";
                                strSQL = "select act_display, expected_display,var_display,signif,signif_g from dbo.PBP_Profile_px_Ph33 as a where spec_id=11 and measure_id not between 40 and 42 and MPIN=" + strMPIN + " order by sort_id";
                                //blProcedureOnlyBreak = true;
                                break;
                            default:
                                break;
                    ...
                    if (blHasUtilizationDetails)
                    {
                        ...
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph33 where Measure_ID=35 and attr_mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                       ...
                       // strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph32 where Measure_ID=36 and attr_mpin=" + strMPIN + " order by Catg_order";
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph33 where Measure_ID=36 and attr_mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        strSQL = "select Category, Patient_Count, Visit_Count , Pct_Cost from dbo.PBP_act_ph33 where Measure_ID=17 and attr_mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph33 where Measure_ID=43 and attr_mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph33 where Measure_ID=37 and attr_mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                       ...
                       // strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph32 where Measure_ID=29 and attr_mpin=" + strMPIN + " order by Catg_order";
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph33 where Measure_ID=29 and attr_mpin=" + strMPIN + " order by Catg_order"; 
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph33 where Measure_ID=5 and attr_mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph33 where Measure_ID=16 and attr_mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph33 where Measure_ID=4 and attr_mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph33 where Measure_ID=3 and attr_mpin=" + strMPIN + " order by Catg_order";
                        ...
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph33 where Measure_ID=2 and attr_mpin=" + strMPIN + " order by Catg_order";
                       ...
                       // strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph32 where Measure_ID=1 and attr_mpin=" + strMPIN + " order by Catg_order";
                        strSQL = "select Category, Patient_Count, Visit_Count, Pct_Cost from dbo.PBP_act_ph33 where Measure_ID=1 and attr_mpin=" + strMPIN + " order by Catg_order";
                    ...
                    if (blHasProceduralDetails)
                    {
                        ...
                        strSQL = "select act_display, expected_display, var_display FROM PBP_Profile_px_Ph33 Where measure_id in (40,41,42) and mpin=" + strMPIN + " order by sort_id";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        if (dt.Rows.Count > 0)
                        {
                        ...
                        strSQL = "select Category, Meas_Cnt, Total_Cnt, Pct from dbo.PBP_act_PX_ph33 where Measure_ID=62 and mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        ...
                        strSQL = "select Category, Meas_Cnt, Total_Cnt, Pct from dbo.PBP_act_PX_ph33 where Measure_ID=49 and mpin=" + strMPIN + " and meas_cnt > 0 order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        ...
                        strSQL = "select Category, Meas_Cnt, Total_Cnt, Pct from dbo.PBP_act_PX_ph33 where Measure_ID=45 and mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        ...
                        strSQL = "select Category, Meas_Cnt, Total_Cnt, Pct from dbo.PBP_act_PX_ph33 where Measure_ID=47 and mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        ...
                        strSQL = "select Category, Meas_Cnt, Total_Cnt, Pct from dbo.PBP_act_PX_ph33 where Measure_ID=46 and mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        ...
                        strSQL = "select Category, Meas_Cnt, Total_Cnt, Pct from dbo.PBP_act_PX_ph33 where Measure_ID=48 and mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        ...
                        strSQL = "select Category, Meas_Cnt, Total_Cnt, Pct from dbo.PBP_act_PX_ph33 where Measure_ID=18 and mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                       ...
                       // strSQL = "select Category as Diagnosis_Category, meas_cnt as Spinal_Fusion_Count, total_cnt as Spinal_Laminectomy_Count, pct as Spinal_Fusion_Rate from dbo.PBP_act_PX_ph32 where Measure_ID=28 and mpin= " + strMPIN + " order by pct desc";
                        strSQL = "select Category, Meas_Cnt, Total_Cnt, Pct from dbo.PBP_act_PX_ph33 where Measure_ID=28 and mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        ...
                        strSQL = "select Category, Meas_Cnt, Total_Cnt, Pct from dbo.PBP_act_PX_ph33 where Measure_ID=64 and mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        ...
                        strSQL = "select Category, Meas_Cnt, Total_Cnt, Pct from dbo.PBP_act_PX_ph33 where Measure_ID=63 and mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        ...
                        strSQL = "select Category, Meas_Cnt, Total_Cnt, Pct from dbo.PBP_act_PX_ph33 where Measure_ID=24 and mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        ...
                        strSQL = "select Category, Meas_Cnt, Total_Cnt, Pct from dbo.PBP_act_PX_ph33 where Measure_ID=23 and mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                      ...
                      //  strSQL = "select Category, meas_cnt as neg_cath_cnt, total_cnt as nbr_caths, Pct as neg_cath_rate from dbo.PBP_act_px_ph32 as a where Measure_ID=22 and MPIN=" + strMPIN + " order by meas_cnt desc";
                        strSQL = "select Category, Meas_Cnt, Total_Cnt, Pct from dbo.PBP_act_PX_ph33 where Measure_ID=22 and mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
                        ...
                        strSQL = "select Category, Meas_Cnt, Total_Cnt, Pct from dbo.PBP_act_PX_ph33 where Measure_ID=21 and mpin=" + strMPIN + " order by Catg_order";
                        dt = DBConnection64.getMSSQLDataTable(strConnectionString, strSQL);
