...
public class IR_SAS_Connect
{
    ...
    public static DataTable runPassthroughSQLCommandsDT(string strSQL)
    {
        ...
        try
        {
            ...
            dt = DBConnection32.getOleDbDataTable(strSASConnectionString, strSQL);
        }
        catch (Exception ex)
        {
            objLangServ.Reset();
    ...
    public static OleDbDataReader runPassthroughSQLCommandsDR(string strSQL)
    {
        ...
        try
        {
            ...
            oleDr = DBConnection32.getOleDbDataReader(strSASConnectionString, strSQL);
        }
        catch (Exception ex)
        {
            objLangServ.Reset();
