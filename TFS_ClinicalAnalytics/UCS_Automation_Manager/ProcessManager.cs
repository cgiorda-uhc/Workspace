...
namespace UCS_Automation_Manager
{
    public static class ProcessManager
    {
        ...
        public static int ManageProcesses(EventLog eventLog, int eventId)
        {
            ...
            //process_MEDNEC(); //INNA
            //process_CGP_Inj_Chemo //SHEILA
            //process_MHP_Monthly_Universes //????
        ...
        private static void processED_ADT()
        {
            ...
            try
            {
                ...
                if (
                    (
                    ((dtNow.Hour == 10 || dtNow.Hour == 11) && dtNow.ToString("tt", CultureInfo.InvariantCulture).ToLower().Equals("am")) //10 OR 11 AM
                    ||
                    ((dtNow.Hour == 12 || dtNow.Hour == 15 || dtNow.Hour == 17) && dtNow.ToString("tt", CultureInfo.InvariantCulture).ToLower().Equals("pm")) //12 OR 2 OR 5 PM
                    )
                    &&
                ...
                files = Directory.GetFiles(strSourcePath, "*_" + strFileDate + ".csv", SearchOption.TopDirectoryOnly);
                ...
                {
                    status = Status.Error;
                    strSubject = "UCS Automation Manager: ED_ADT ERROR!!!";
                ...
                else if (intFileCnt >= 25) //AT LEAST MINIMUM SO LETS PROCESSES!!!!
                {
                    ...
                    try
                    {
                        ...
                        if (File.Exists(strFinalFile))
                        {
                            ...
                            strSubject = "UCS Automation Manager: ED_ADT file generated! ("+ DateTime.Now.ToString("MM/dd/yyyy h:mm tt") + ")";
                        ...
                        else
                        {
                            ...
                            status = Status.Error;
                            strSubject = "UCS Automation Manager: ED_ADT failed! (" + DateTime.Now.ToString("MM/dd/yyyy h:mm tt") + ")";
                ...
                else
                {
                    ...
                    status = Status.Fail;
                    strSubject = "UCS Automation Manager: ED_ADT no source files! (" + DateTime.Now.ToString("MM/dd/yyyy h:mm tt") + ")";
                    var strHowLong = "1 hr";
