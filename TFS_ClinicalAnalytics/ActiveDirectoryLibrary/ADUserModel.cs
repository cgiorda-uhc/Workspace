...
namespace ActiveDirectoryLibrary
{
    public class ADUserModel
    {
        ...
        private ADUserModel(DirectoryEntry directoryUser)
        {
        ...
        public static ADUserModel GetUser(DirectoryEntry directoryUser)
        {
            return new ADUserModel(directoryUser);
        }
    }
}
