...
namespace TFS_ClinicalAnalyticsML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\cgiorda\AppData\Local\Temp\2e12eb91-7d75-4bf9-b5e3-ce1432cc2362.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\cgiorda\AppData\Local\Temp\MLVSTools\TFS_ClinicalAnalyticsML\TFS_ClinicalAnalyticsML.Model\MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.LightGbm(labelColumnName: "Hydroxychlo", featureColumnName: "Features");
        ...
        private static void Evaluate(MLContext mlContext, IDataView trainingDataView, IEstimator<ITransformer> trainingPipeline)
        {
            ...
            var crossValidationResults = mlContext.BinaryClassification.CrossValidateNonCalibrated(trainingDataView, trainingPipeline, numberOfFolds: 5, labelColumnName: "Hydroxychlo");
