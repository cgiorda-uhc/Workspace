CREATE VIEW [dbo].[vw_GetETGSymmetryTracking]
	AS 
...
, p.Premium_Specialty
	...
	,t.[username]
	,t.[update_date]
  FROM [dbo].[ETG_Fact_Symmetry_Update_Tracker] t
  INNER JOIN [dbo].[ETG_Fact_Symmetry] as f ON f.ETG_Fact_Symmetry_Id = t.ETG_Fact_Symmetry_id
