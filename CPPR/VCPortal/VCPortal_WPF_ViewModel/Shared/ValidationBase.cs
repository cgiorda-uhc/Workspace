...
public class ValidationBase : ObservableObject, INotifyDataErrorInfo
{

 
    /// https://www.c-sharpcorner.com/UploadFile/tirthacs/inotifydataerrorinfo-in-wpf/
    ...
    public void ValidateProperty(object value,string propertyName = null)
    {
        lock (_lock)
        {
