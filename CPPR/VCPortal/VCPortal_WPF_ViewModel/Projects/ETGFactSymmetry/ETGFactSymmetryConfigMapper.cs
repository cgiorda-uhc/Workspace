...
public static class ETGFactSymmetryConfigMapper
{
    ...
    internal static List<ETGSummaryConfig> getETGSummaryConfig(IEnumerable<ETGFactSymmetryViewModel> esmList)
    {
        var targetList = esmList.Select(x => new ETGSummaryConfig()
        {
            ...
            PC_Spec_Episode_Distribution = x.PC_Spec_Episode_Distribution,
            PC_Spec_Perc_of_Episodes = x.PC_Spec_Percent_of_Episodes,
            PC_Spec_Tot_Cost = x.PC_Spec_Total_Cost,
            PC_Spec_Avg_Cost = x.PC_Spec_Average_Cost,
            PC_Spec_Normalized_Pricing = x.PC_Normalized_Pricing_Total_Cost,
            PC_Spec_CV = x.PC_Spec_CV,
            ...
            EC_Spec_Normalized_Pricing = x.EC_Normalized_Pricing_Total_Cost,
