...
{
    public class DB2DataAccess : IRelationalDataAccess
    {
        ...
        public Task<object> Execute(string connectionString, string sql)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<IDataReader> LoadData(string connectionString, string sql)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<DataTable> LoadDataTable(string connectionString, string sql)
        {
            throw new NotImplementedException();
        }
