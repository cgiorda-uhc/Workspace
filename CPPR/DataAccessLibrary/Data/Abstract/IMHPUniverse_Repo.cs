...
namespace DataAccessLibrary.Data.Abstract
{
    public interface IMHPUniverse_Repo
    {
        ...
        Task<IEnumerable<MHPEIDetails_Model>> GetMHPEIDetailsAllAsync(string strState, string strStartDate, string strEndDate, string strFINC_ARNG_DESC, string strMKT_SEG_RLLP_DESC, string strLegalEntities, string strMKT_TYP_DESC, string strCUST_SEG, CancellationToken token);
