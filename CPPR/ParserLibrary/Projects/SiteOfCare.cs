...
public class SiteOfCare : ISiteOfCare
{
    ...
    public SiteOfCare(IConfiguration config, IRelationalDataAccess db)
    {
        //INJECT DB SOURCES
        _db = db;
    ...
    public async Task<long> LoadSiteOfCareData()
    {
        ...
        if (_config == null)
        {
            Log.Error($"No Config found for SiteOfCare data load");
